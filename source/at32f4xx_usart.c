...
void USART_Reset(USART_Type* USARTx)
{
  ...
  {
    RCC_APB1PeriphResetCmd(RCC_APB2PERIPH_UART7, ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB2PERIPH_UART7, DISABLE);
  }
  else if (USARTx == UART8)
  {
    RCC_APB1PeriphResetCmd(RCC_APB2PERIPH_UART8, ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB2PERIPH_UART8, DISABLE);
  }
#endif
}
...
void USART_Init(USART_Type* USARTx, USART_InitType* USART_InitStruct){
  ...
  /*---------------------------- USART BRR Configuration -----------------------*/
	USART_SetBaudrate(USARTx, USART_InitStruct->USART_BaudRate);
}
