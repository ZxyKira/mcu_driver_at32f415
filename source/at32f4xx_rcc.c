...
void RCC_PLLFrefTableConfig(uint32_t hse_value)
{
  ...
  else
  {
    ...
    if((pllrcfreq > 3.9) && (pllrcfreq < 5))
    {
        pll_reg |= PLL_FREF_4M;
    }
    else if((pllrcfreq > 5.2) && (pllrcfreq < 6.25))
    {
        pll_reg |= PLL_FREF_6M;
    }
    else if((pllrcfreq > 7.8125) && (pllrcfreq < 8.33))
    {
        pll_reg |= PLL_FREF_8M;
    }
    else if((pllrcfreq > 8.33) && (pllrcfreq < 12.5))
    {
        pll_reg |= PLL_FREF_12M;
    }
    else if((pllrcfreq > 15.625) && (pllrcfreq < 20.83))
    {
        pll_reg |= PLL_FREF_16M;
    }
    else if((pllrcfreq > 20.83) && (pllrcfreq < 31.255))
    {
